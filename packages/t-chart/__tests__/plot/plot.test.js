...
describe("plot", () => {
  it("interval with field encoding", () => {
    const chart = sp.plot({
      type: "interval",
      data: sports,
      encodings: {
  ...
  it("interval with negative values", () => {
    const chart = sp.plot({
      type: "interval",
      data: negative,
      scales: {
  ...
  it("pyramid interval with transform encoding", () => {
    const chart = sp.plot({
      type: "interval",
      data: rainfall,
      paddingLeft: 60,
  ...
  it("layerd text and interval with y and y1 encoded", () => {
    const chart = sp.plot({
      type: "layer",
      data: profit,
      encodings: {
  ...
  it("point with interpolated log scale", () => {
    const chart = sp.plot({
      data: countries,
      type: "point",
      scales: {
  ...
  it("stacked and symmetried area", () => {
    const chart = sp.plot({
      type: "area",
      data: countries,
      guides: {
  ...
  it("facet skip", async () => {
    const response = await fetch("https://gw.alipayobjects.com/os/antvdemo/assets/data/diamond.json");
  ...
  it("ribbon", async () => {
    const response = await fetch("https://gw.alipayobjects.com/os/bmw-prod/b45f3425-04bc-454a-8edd-26a0b4fc28d6.json");
    const data = await response.json();
